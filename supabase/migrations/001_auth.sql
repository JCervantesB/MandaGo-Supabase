...
-- ============================================================
-- Trigger: Auto-create company on signup (NOT internal_user for security)
-- ============================================================
...
BEGIN
  ...
  -- Note: internal_user is NOT created automatically for security
  -- Admin should manually create the first user or promote after verification
